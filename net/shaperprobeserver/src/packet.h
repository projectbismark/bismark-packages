...
int sendtowrapper(int sock, char *buf, size_t size, int flags, const struct sockaddr *dest, socklen_t addrlen, double capacity, struct timeval curTS, double sleepRes);
